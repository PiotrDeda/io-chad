...
// zaladownie info o turnieju
const props = defineProps({
    amouont: {type: Number, required: false, default: 16},
...
const comps = ref([
    ...
    { name: 'szesnaście', list: 1},
])

const loadPairs = () => {
    for(let i=1; i < 1+props.amouont/2; i++){
        console.log(props.amouont)
...
<template>
    ...
    <div id="button_panel">
            <button id="reset" onclick=resetLayout> Resetuj układ </button>  
            <button id="send" onclick=sendBracket> Zapisz układ </button>  
    </div>
